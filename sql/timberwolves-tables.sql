...
insert into player (jerseyNumber, firstName, lastName, nicknames, heightInInches, weightInPounds, previousTeamId) values 
	(0, "D'Angelo", 'Russell', 'DLo', 76, 193, 10),
    (1, 'Anthony', 'Edwards', 'Ant', 76, 225, null),
    (3, 'Jaden', 'McDaniels', null, 81, 185, null),
    (4, 'Jaylen', 'Nowell', 'Big Tymah', 76, 201, null),
    (5, 'Malik', 'Beasley', 'The Mutant', 76, 187, 8),
    (6, 'Jordan', 'McLaughlin', 'J-Mac', 71, 185, null),
    (8, 'Jarred', 'Vanderbilt', 'Vando, Vandolorian', 81, 214, 8),
    (9, 'Leandro', 'Bolmaro', null, 78, 200, null),
    (10, 'Jake', 'Layman', 'Sunshine', 80, 209, 25),
    (11, 'Naz', 'Reid', 'Big Jelly', 81, 264, null),
    (12, 'Taurean', 'Prince', null, 79, 218, 6),
    (13, 'Nathan', 'Knight', 'Nate', 82, 253, 1),
    (20, 'Josh', 'Okogie', 'Non-stop', 78, 213, null),
    (22, 'Patrick', 'Beverley', 'Mr. 94 Feet', 73, 180, 13),
    (25, 'McKinley', 'Wright IV', null, 72, 196, null),
    (32, 'Karl-Anthony', 'Towns', 'KAT', 83, 248, null);
...
insert into game (`date`, opponentId, wolvesScore, opponentScore) values
    ...
    ('2022-01-28', 24, 124, 134),
    ('2022-01-30', 29, 126, 106),
...
select
	g.game_id,
    g.`date`,
    concat(t.location, ' ', t.nickname) as opponent,
    g.wolvesScore,
    g.opponentScore
    from game g
    inner join team t on g.opponentId = t.team_id;
